...
public class B_Else {
	 ...
	 * 코드 3 .. }[else { .. 위의 조건들이 다 false일 경우 실행할 코드 .. }] << [] 생략가능 '또는'이 아예없는경우
	 * 
...
//			System.out.println("홀수입니다.");
	...
	public void method3() {
		...
		System.out.println(grade + " 학년 " + classNum + "반 " + student + " " + name + "학생입니다.");
	...
	public void method4() {
		...
		// if-else if 구문은 위의 조건구문을 만족하지못하고 내려왔기때문에 당연히
		// 위의 조건의 반대조건을 내부적으로 포함하고있다.
