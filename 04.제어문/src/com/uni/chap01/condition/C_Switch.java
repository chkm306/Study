...
public class C_Switch {
	 ...
	 * * switch문
	 * 
	 * switch(동등비교할대상자){ // 여기서 동등비교할 대상자는 반드시 int값이나, char, String 밖에 불가!! //시험에
	 * 나옴★★★★★★★★★★★★★★★ case 값1 : 실행코드1; break; case 값2 : 실행코드2; break; case 값3 :
	 * 실행코드3; break; ... default : 위의 조건에 다 만족하지 않을 경우 실행할 코드; }
	 * 
...
//			break;
	...
	public void method3() {
		...
		Scanner sc = new Scanner(System.in);
		System.out.println("1~12월 까지 중 하나를 입력하세요 : ");
...
//			break;
		...
		case 11:
			...
			break;
		case 2:
			System.out.println("입력하신 월은 28일 까지입니다.");
			break;
		default :
