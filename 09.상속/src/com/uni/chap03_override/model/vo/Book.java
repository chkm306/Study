...
public class Book {
	...
	// 2. equals 메소드의 내용을 주소값 비교가 아닌 실제 필드값들이 모두 같을 경우 true를 반환하고,
	//    하나라도 틀릴때는 false를 반환하도록 재정의하자
	@Override
	...
	//        자료형 : Book                     Object
		...
		if(!(obj instanceof Book)) { // Book으로 형변환을 할 수있냐? => !
			return false;
		}
		
		Book other = (Book)obj; // Book 타입으로 형변환을 한거임
		//      bk1.equals(bk2)
...
//		return super.equals(obj);
	...
	// 3. 해쉬코드 (동일한 문자열이 있으면 메소드를 사용해서 )(Cast클래스참고)
	@Override
	public int hashCode() {
...
//		return (title + author + price).hashCode();
		...
		// 주어진 매개값들로 배열을 생성하고 arrays.hashcode(Object[])를 호출해서 해쉬코드를 얻고 이값을 리턴해줌
