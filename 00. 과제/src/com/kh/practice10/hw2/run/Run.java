package com.kh.practice10.hw2.run;

import java.util.Scanner;
import com.kh.practice10.hw2.model.vo.Student;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if(str.equals("n")) { //문자열 비교
				break;
			}
		}

		// 현재 배열에 담겨있는 학생들의 정보를 모두 출력+ 각 학생의 평균 점수를 출력
		for (int i = 0; i < stu.length; i++) {
			int num = (stu[i].getKor() + stu[i].getMath() + stu[i].getEng()) / 3;
			
			System.out.println(stu[i].information() + ", 평균 = " + num);
		}
	}
}
