package com.kh.practice10.mvc.view;

import java.util.Scanner;

import com.kh.practice10.mvc.controller.MemberController;
import com.kh.practice10.mvc.model.vo.Member;
	...
	public void insertMember() {
		...
		if (mc.getMemberCount() > MemberController.SIZE) { // mc.SIZE로 했더니 오류 클래스명 입력
			...
			if (mc.checkId(userId) != null) {
				...
				// Member의 매개변수 생성자를 이용하여 객체 생성
				Member memb = new Member(userId, userPwd, userName, userAge, userGender, userEmail);

				// MemberController의 insertMember() 메소드로 전달
				mc.insertMember(memb);
