package com.kh.practice8.example1.run;

import com.kh.practice8.example1.model.vo.Product;
...
public class ProductTest {
	...
	public static void main(String[] args) {
		...
		Product p1 = new Product("ssgnote9", "갤럭시노트9", "경기도 수원", 96000, 10.0);
		Product p2 = new Product("lgxnote5", "LG스마트폰", "경기도 평택", 78000, 0.7);
		Product p3 = new Product("ktsnote3", "KT스마트폰3", "서울시 강남", 25000, 0.3);
