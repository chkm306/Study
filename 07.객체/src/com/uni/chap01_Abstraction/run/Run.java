package com.uni.chap01_Abstraction.run;

import com.uni.chap01_Abstraction.model.vo.Student;
...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 *    3) 그렇게 추출한 것들을 가지고 내가 구현하고자 하는 프로그램의 "실직적인 목적"에 맞춰 불필요한 속성, 기능들을 제거할 것
		...
		Student u = new Student(); // heap영역에 공간 생성
		u.name = "유산슬"; // 메소드말고 다른것도 뜬다
		u.age = 20;
		u.height = 190;
		u.kor = 100;
		u.math = 90;
		...
		// 직접 접근을 통해 값 가져오기
		System.out.println(u.name + "님의 나이는 " + u.age + " 이고, 국어점수는 " + u.kor + " 이고, 수학점수는 " + u.math);

		Student r = new Student();
		r.name = "로운"; // 메소드말고 다른것도 뜬다
		r.age = 20;
		r.height = 190;
		r.kor = 100;
		r.math = 90;
		
		System.out.println(r.name + "님의 나이는 " + r.age + " 이고, 국어점수는 " + r.kor + " 이고, 수학점수는 " + r.math);
