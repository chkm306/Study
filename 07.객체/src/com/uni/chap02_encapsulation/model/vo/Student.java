...
public class Student {
	...
	public Student() {
		// 매개변수가 없는 생성자를 기본 생성자라고 한다. (단지 생성만을 목적으로 하는 것)
	}
	...
	public void setName(String name) {
		//name = name;일 경우 매개변수 name = 매개변수 name 해당하는 메소드 안에서는 우선순위가 매개변수가 더 높다.
		
		// this : 인스턴스(객체)자신을 가리키는 참조변수, 인스턴스 주소값이 담겨있다.
		// 필드의 name = 매개변수 name
		this.name = name;
	...
	// 반환해주려는 게터메소드 반환형 필요하지만 매개변수는 필요없음
	...
	public int getMath() {
		return math; // 필드에 있는 멤버변수 자기꺼를 가르키게 되어있다. 매개변수 받아오는게 없으면
		//
	}

	public String information() {
		String info = "이름 : "+name + " , 나이"+age+" , 키 "+height+" , 국어점수 ㅣ "+kor+" , 수학점수 :"+math;
		return info;
	}
}
