...
public class User {
	...
	// 기본 생성자 --> public 클래스명(){} : 단지 객체 생성만을 목적으로 하고 있다. 매개 변수 생성자가 있으면 생략 불가능
	public User() {
	}

	// 매개 변수가 있는 생성자는 (사용자가 직접 만듦) --> public 클래스명(매개변수) : 객체 생성과 동시에 전달된 값들을 매개변수로
	// 담아서 해당 필드에 초기화하는 목적
	public User(String userId, String userPwd, String userName) {
		...
		// this : 인스턴스 자신을 가리키는 참조변수, 주소가 저장되어있다.

		// 나머지 필드 부분은 JVM의 초기값으로 들어가있다.
	}
